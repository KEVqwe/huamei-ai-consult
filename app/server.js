...
const IMAGE_CATALOG = [
  ...
  // —— 医生介绍（整形外科9位） ——
  { file: '医生介绍/整形外科/佀同帅医生/【佀同帅个人介绍】长图修改.jpg', tags: ['医生', '佀医生', '佀同帅', '眼部', '显微眼', '重睑'], desc: '佀医生（眼部整形专家）' },
  { file: '医生介绍/整形外科/陈小剑医生/陈小剑个人简介长图.jpg', tags: ['医生', '陈医生', '陈小剑', '眼部', '重睑修复', '眼袋'], desc: '陈医生（眼部整形专家）' },
  { file: '医生介绍/整形外科/叶丽萍医生/叶丽萍个人总介绍.jpg', tags: ['医生', '叶医生', '叶丽萍', '鼻部', '隆鼻', '海鸥线', '面部提升'], desc: '叶医生（鼻整形/面部提升）' },
  { file: '医生介绍/整形外科/李健医生/李健-个人总介绍.jpg', tags: ['医生', '李健医生', '李健', '鼻部', '隆鼻', '隆胸', '面部提升', '脊状肋'], desc: '李健医生（鼻整形/隆胸/面部年轻化）' },
  { file: '医生介绍/整形外科/张朋医生/【张朋个人介绍】总介绍修改.jpg', tags: ['医生', '张医生', '张朋', '鼻部', '吸脂', '体雕'], desc: '张医生（鼻整形/吸脂塑形）' },
  { file: '医生介绍/整形外科/谢卫国医生/谢卫国个人总介绍.jpg', tags: ['医生', '谢医生', '谢卫国', '隆胸', '动感隆胸', '自体脂肪'], desc: '谢医生（隆胸/自体脂肪）' },
  { file: '医生介绍/整形外科/胡小清医生/胡小清个人总介绍.jpg', tags: ['医生', '胡医生', '胡小清', '眼部', '唇部', '私密'], desc: '胡医生（眼整形/唇部/私密）' },
  { file: '医生介绍/整形外科/李志海医生/李志海个人介绍.jpg', tags: ['医生', '李志海医生', '李志海', '颌面', '下颌角', '颧骨', '轮廓', '改脸型'], desc: '李志海医生（颌面轮廓）' },
  { file: '医生介绍/整形外科/弓辉辉医生/弓辉辉长图介绍.jpg', tags: ['医生', '弓医生', '弓辉辉', '整形外科'], desc: '弓医生（整形外科）' },
  // —— 微整形医生团队 ——
  ...
  { file: '医生介绍/注射美容科/聂婕 技术院长/027625f9671d47ed9db38a9aac4272b0.png', tags: ['医生', '聂医生', '聂婕', '微整', '注射'], desc: '聂医生（微整技术院长）' },
  { file: '医生介绍/注射美容科/赵伟 技术院长/8aec4289bba3432492bc5db9a5c0f750.png', tags: ['医生', '赵医生', '赵伟', '微整', '注射'], desc: '赵医生（微整技术院长）' },
  { file: '医生介绍/注射美容科/安丰鹏 主任/fd9f10c0cde4479597183b09e8b868a8.png', tags: ['医生', '安医生', '安丰鹏', '微整', '注射'], desc: '安医生（微整注射主任）' },
  { file: '医生介绍/注射美容科/成建璋主任/ae12ba5a6a704926860628e736b86c1c.png', tags: ['医生', '成医生', '成建璋', '微整', '注射'], desc: '成医生（微整注射主任）' },
  { file: '医生介绍/注射美容科/魏开轩主任/3fcf10ff416a46e6942e15a573b01e9c.png', tags: ['医生', '魏医生', '魏开轩', '微整', '注射'], desc: '魏医生（微整注射主任）' },
  // —— 皮肤美容科10位 ——
  { file: '医生介绍/皮肤美容科/曹小曼医生/f0d07450118a44eba2fa5f7e2d034df7.png', tags: ['医生', '曹医生', '曹小曼', '皮肤', '光电'], desc: '曹医生（皮肤美容）' },
  ...
  // —— 口腔美容科 ——
  { file: '医生介绍/口腔美容科/张院长/f286dd2d0ff2475fa421dc8985099a29.jpg', tags: ['医生', '张群医生', '张群', '口腔', '种植', '正畸'], desc: '张群医生（口腔种植/正畸）' },
  { file: '医生介绍/口腔美容科/黄院长/c084798b96744e7db3fd1f59fbb3ae45.jpg', tags: ['医生', '黄医生', '黄嵩', '口腔', '种植'], desc: '黄嵩医生（口腔种植/正畸）' },
  // —— 毛发移植科 ——
  { file: '医生介绍/毛发移植科/刘主任/刘学新个人介绍.jpg', tags: ['医生', '刘医生', '刘学新', '植发', '毛发移植', '发际线'], desc: '刘医生（毛发移植）' },
  // —— 特邀专家（韩国） ——
