...
const IMAGE_CATALOG = [
  ...
  { file: '明星产品/瑞可丽居家产品/瑞可丽修复乳/修复乳.jpg', tags: ['皮科', '修复乳', '瑞可丽', '居家'], desc: '瑞可丽修复乳' },
  { file: '明星产品/瑞可丽居家产品/瑞可丽凝胶/凝胶.jpg', tags: ['皮科', '凝胶', '瑞可丽', '居家'], desc: '瑞可丽凝胶' },
  { file: '明星产品/瑞可丽居家产品/瑞可丽喷雾/喷雾.jpg', tags: ['皮科', '喷雾', '瑞可丽', '居家'], desc: '瑞可丽喷雾' },
  { file: '明星产品/瑞可丽居家产品/瑞可丽洁面慕斯/洁面慕斯.jpg', tags: ['皮科', '洁面', '瑞可丽', '居家'], desc: '瑞可丽洁面慕斯' },
  { file: '明星产品/瑞可丽居家产品/瑞可丽精华液/精华液.jpg', tags: ['皮科', '精华液', '瑞可丽', '居家'], desc: '瑞可丽精华液' },
  { file: '明星产品/瑞可丽居家产品/瑞可丽透明质酸敷料/敷贴面膜.jpg', tags: ['皮科', '敷料', '瑞可丽', '修复', '械字号'], desc: '瑞可丽透明质酸敷料（械字号）' },
  { file: '明星产品/瑞可丽居家产品/瑞可丽面膜/面膜.jpg', tags: ['皮科', '面膜', '瑞可丽', '居家', '胶原'], desc: '瑞可丽胶原面膜' },
  ...
  { file: '6月份政策/皮肤政策/皮肤政策/皮肤-01.jpg', tags: ['皮科', '皮肤政策', '光电', '水光', '价目'], desc: '皮肤科政策详情（光电/水光）' },
  { file: '6月份政策/皮肤政策/皮肤政策/皮肤-02.jpg', tags: ['皮科', '皮肤政策', '抗衰', '微针'], desc: '皮肤科政策详情（抗衰/微针）' },
  { file: '6月份政策/皮肤政策/皮肤政策/皮肤-03.jpg', tags: ['皮科', '皮肤政策', '套餐', '疗程'], desc: '皮肤科政策详情（套餐/疗程）' },
  { file: '6月份政策/皮肤套餐/皮肤套餐-01.jpg', tags: ['皮科', '皮肤套餐', '套餐'], desc: '皮肤美容套餐' },
  // —— 瑞可丽明星产品 ——
  { file: '明星产品/瑞可丽中胚产品/瑞可丽小金瓶/瑞可丽 小金瓶.jpg', tags: ['皮科', '小金瓶', '瑞可丽', '抗衰'], desc: '瑞可丽小金瓶（高端抗衰）' },
  { file: '明星产品/瑞可丽中胚产品/瑞可丽小银瓶/小银瓶.jpg', tags: ['皮科', '小银瓶', '瑞可丽', '补水'], desc: '瑞可丽小银瓶（补水抗衰）' },
  { file: '明星产品/瑞可丽中胚产品/瑞可丽聚光尊/聚光尊.jpg', tags: ['皮科', '聚光尊', '瑞可丽', '美白', '去暗黄'], desc: '瑞可丽聚光尊（去暗黄提亮）' },
  { file: '明星产品/瑞可丽中胚产品/瑞可丽豆仙优/豆仙优.jpg', tags: ['皮科', '豆仙优', '瑞可丽', '祛痘', '控油'], desc: '瑞可丽豆仙优（控油祛痘）' },
  { file: '明星产品/瑞可丽中胚产品/瑞可丽殊敏适/殊敏适.jpg', tags: ['皮科', '殊敏适', '舒敏适', '瑞可丽', '修复', '敏感'], desc: '瑞可丽殊敏适（舒缓修复）' },
  { file: '明星产品/瑞可丽中胚产品/瑞可丽粉色美白套/粉色美白.jpg', tags: ['皮科', '粉色美白套', '瑞可丽', '美白'], desc: '瑞可丽粉色美白套' },
  { file: '明星产品/瑞可丽中胚产品/瑞可丽蓝色修复套/蓝色修复.jpg', tags: ['皮科', '蓝色修复套', '瑞可丽', '修复'], desc: '瑞可丽蓝色修复套（术后修复）' },
  { file: '明星产品/瑞可丽中胚产品/瑞可丽绿色祛痘套/绿色祛痘套.jpg', tags: ['皮科', '绿色祛痘套', '瑞可丽', '祛痘'], desc: '瑞可丽绿色祛痘套' },
  { file: '明星产品/禧善产品介绍/禧善产品.jpg', tags: ['皮科', '禧善', '产品'], desc: '禧善合作产品' },
  // —— 微整形 ——
  ...
  // —— 口腔美容科 ——
  { file: '口腔美容科/种植牙价格表.png', tags: ['口腔', '种植牙', '种牙', '种植体', 'NobelActive'], desc: '种植牙价格表' },
  { file: '口腔美容科/正畸价格表.png', tags: ['口腔', '正畸', '矫正', '隐适美', '牙套'], desc: '正畸矫正价格表' },
  { file: '口腔美容科/牙冠贴面价格表.png', tags: ['口腔', '贴面', '牙冠', '全瓷牙', '烤瓷牙'], desc: '牙冠贴面价格表' },
  { file: '口腔美容科/美白洁牙价格表.png', tags: ['口腔', '美白', '洁牙', '洗牙', '皓齿'], desc: '美白洁牙价格表' },
  // —— 整形外科 ——
  { file: '6月份政策/外科政策/外科-01.jpg', tags: ['外科', '双眼皮', '隆鼻', '吸脂', '手术'], desc: '整形外科本月政策' },
  { file: '项目价格/整形外科/眼部综合套餐/眼部综合套餐.png', tags: ['外科', '眼部套餐', '重睑', '眼袋', '套餐'], desc: '眼部综合套餐价目' },
  { file: '项目价格/整形外科/鼻部综合套餐/鼻部综合套餐.png', tags: ['外科', '鼻部套餐', '鼻综合', '肋软骨', '套餐'], desc: '鼻部综合套餐价目' },
  { file: '项目价格/整形外科/外籍专家收费标准/外籍专家收费标准-01.jpg', tags: ['外科', '外籍专家', '韩国专家', '韩国医生'], desc: '外籍专家（韩国）收费标准' },
  // —— 私密 ——
  ...
  { file: '医生介绍/注射美容科/彭光群院长/fe870f1fb438456ea50b294dcc21d915.png', tags: ['医生', '彭医生', '彭光群', '微整', '注射'], desc: '彭医生（微整注射院长）' },
