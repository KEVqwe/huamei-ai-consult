...
const IMAGE_CATALOG = [
  // —— 瑞可丽中胚层治疗产品 ——
  { file: '明星产品/瑞可丽中胚产品/组合 拷贝.jpg', tags: ['产品', '瑞可丽', '中胚', '胶原'], desc: '瑞可丽中胚产品系列' },
  ...
  { file: '明星产品/瑞可丽中胚产品/瑞可丽聚光尊/绿色祛痘套 拷贝.jpg', tags: ['产品', '聚光尊', '瑞可丽', '美白', '去暗黄'], desc: '瑞可丽聚光尊（去暗黄提亮）' },
  { file: '明星产品/瑞可丽中胚产品/瑞可丽豆仙优/绿色祛痘套 拷贝 3.jpg', tags: ['产品', '豆仙优', '瑞可丽', '祛痘', '控油'], desc: '瑞可丽豆仙优（控油祛痘）' },
  { file: '明星产品/瑞可丽中胚产品/瑞可丽殊敏适/绿色祛痘套 拷贝 2.jpg', tags: ['产品', '殊敏适', '舒敏适', '瑞可丽', '修复', '敏感'], desc: '瑞可丽殊敏适（舒缓修复）' },
  { file: '明星产品/瑞可丽中胚产品/瑞可丽粉色美白套/粉色美白.jpg', tags: ['产品', '粉色美白套', '瑞可丽', '美白'], desc: '瑞可丽粉色美白套' },
  { file: '明星产品/瑞可丽中胚产品/瑞可丽蓝色修复套/蓝色舒缓修复.jpg', tags: ['产品', '蓝色修复套', '瑞可丽', '修复'], desc: '瑞可丽蓝色修复套（术后修复）' },
  { file: '明星产品/瑞可丽中胚产品/瑞可丽绿色祛痘套/绿色祛痘套.jpg', tags: ['产品', '绿色祛痘套', '瑞可丽', '祛痘'], desc: '瑞可丽绿色祛痘套' },
  // —— 瑞可丽居家养护产品 ——
  { file: '明星产品/瑞可丽居家产品/组合(1).jpg', tags: ['产品', '居家', '面膜', '修复乳', '护肤品'], desc: '瑞可丽居家产品系列' },
  ...
  // —— 会员卡 ——
  { file: '明星产品/明星产品价格表/明星产品政策-01.jpg', tags: ['产品', '明星产品', '价目表', '买二送一'], desc: '明星产品价格政策' },
  { file: '明星产品/禧善产品介绍/0fd76d2744244485a0539e1baea453a0.jpg', tags: ['产品', '禧善'], desc: '禧善合作产品' },
  { file: '医生介绍/皮肤美容科/大光电美肤中心/1df8343b1ae519e19d1677b7e431df8.jpg', tags: ['医生', '光电中心', '皮肤', '光电'], desc: '大光电美肤中心' },
  { file: '荟员升级权益/1.jpg', tags: ['会员', '荟员', 'vip', '雏菊粉卡', 'V1'], desc: '荟员权益 V1雏菊粉卡' },
  { file: '荟员升级权益/2.jpg', tags: ['会员', '荟员', '银卡', '茉莉银卡', 'V2'], desc: '荟员权益 V2茉莉银卡' },
  { file: '荟员升级权益/3.jpg', tags: ['会员', '金卡', '荟员', '玫瑰金卡', 'V3'], desc: '荟员权益 V3玫瑰金卡' },
  { file: '荟员升级权益/4.jpg', tags: ['会员', '荟员', '钻卡', '山茶钻卡', 'V4'], desc: '荟员权益 V4山茶钻卡' },
  { file: '荟员升级权益/5.jpg', tags: ['会员', '荟员', '黑卡', '铃兰黑卡', 'V5'], desc: '荟员权益 V5铃兰黑卡' },
  // —— 整形外科9位 ——
  ...
  // —— 注射美容科7位 ——
  { file: '医生介绍/注射美容科/彭光群院长/fe870f1fb438456ea50b294dcc21d915.jpg', tags: ['医生', '彭医生', '彭光群', '微整', '注射'], desc: '彭医生（微整注射院长）' },
  { file: '医生介绍/注射美容科/李帅华 技术院长/7763af354451d77683cffc07ffeab74e.jpg', tags: ['医生', '李帅华医生', '李帅华', '微整', '注射'], desc: '李帅华医生（微整技术院长）' },
  { file: '医生介绍/注射美容科/聂婕 技术院长/027625f9671d47ed9db38a9aac4272b0.jpg', tags: ['医生', '聂医生', '聂婕', '微整', '注射'], desc: '聂医生（微整技术院长）' },
  { file: '医生介绍/注射美容科/赵伟 技术院长/8aec4289bba3432492bc5db9a5c0f750.jpg', tags: ['医生', '赵医生', '赵伟', '微整', '注射'], desc: '赵医生（微整技术院长）' },
  { file: '医生介绍/注射美容科/安丰鹏 主任/fd9f10c0cde4479597183b09e8b868a8.jpg', tags: ['医生', '安医生', '安丰鹏', '微整', '注射'], desc: '安医生（微整注射主任）' },
  { file: '医生介绍/注射美容科/成建璋主任/ae12ba5a6a704926860628e736b86c1c.jpg', tags: ['医生', '成医生', '成建璋', '微整', '注射'], desc: '成医生（微整注射主任）' },
  { file: '医生介绍/注射美容科/魏开轩主任/3fcf10ff416a46e6942e15a573b01e9c.jpg', tags: ['医生', '魏医生', '魏开轩', '微整', '注射'], desc: '魏医生（微整注射主任）' },
  // —— 皮肤美容科10位 ——
  { file: '医生介绍/皮肤美容科/曹小曼/f0d07450118a44eba2fa5f7e2d034df7.jpg', tags: ['医生', '曹医生', '曹小曼', '皮肤', '光电'], desc: '曹医生（皮肤美容）' },
  { file: '医生介绍/皮肤美容科/常春/53823046608f4f5881754f4623ff547e.jpg', tags: ['医生', '常医生', '常春', '皮肤', '光电'], desc: '常医生（皮肤美容）' },
  { file: '医生介绍/皮肤美容科/陈靓靓/手卡 - 陈靓靓.jpg', tags: ['医生', '陈靓靓医生', '陈靓靓', '皮肤', '光电'], desc: '陈靓靓医生（皮肤美容）' },
  { file: '医生介绍/皮肤美容科/谭书敏/4abe46782d5c409cacecf8f176ad21a3.jpg', tags: ['医生', '谭医生', '谭书敏', '皮肤', '光电'], desc: '谭医生（皮肤美容）' },
  { file: '医生介绍/皮肤美容科/唐清丽/2e805516cfd24e4a953741a9e1556875.jpg', tags: ['医生', '唐医生', '唐清丽', '皮肤', '光电'], desc: '唐医生（皮肤美容）' },
  { file: '医生介绍/皮肤美容科/田艳艳/7af4658c481c41f38cd2d557418c8dab.jpg', tags: ['医生', '田医生', '田艳艳', '皮肤', '光电'], desc: '田医生（皮肤美容）' },
  { file: '医生介绍/皮肤美容科/王倩/8e624ce837f14ef799b9c8cd3e2ae2b1.jpg', tags: ['医生', '王医生', '王倩', '皮肤', '光电'], desc: '王医生（皮肤美容）' },
  { file: '医生介绍/皮肤美容科/吴丽果/d283e5ae404c4db88a76c7c43ea068fd.jpg', tags: ['医生', '吴医生', '吴丽果', '皮肤', '光电'], desc: '吴医生（皮肤美容）' },
  { file: '医生介绍/皮肤美容科/杨立群/手卡-杨立群.jpg', tags: ['医生', '杨医生', '杨立群', '皮肤', '光电'], desc: '杨医生（皮肤美容）' },
  { file: '医生介绍/皮肤美容科/张琳琳/80aedf0291fb435c821ce1efa9527b50.jpg', tags: ['医生', '张琳琳医生', '张琳琳', '皮肤', '光电'], desc: '张琳琳医生（大光电美肤中心）' },
  // —— 口腔美容科2位 ——
  { file: '医生介绍/口腔美容科/张群院长/f286dd2d0ff2475fa421dc8985099a29.jpg', tags: ['医生', '张群医生', '张群', '口腔', '种植', '正畸'], desc: '张群医生（口腔种植/正畸）' },
  { file: '医生介绍/口腔美容科/黄嵩院长/c084798b96744e7db3fd1f59fbb3ae45.jpg', tags: ['医生', '黄医生', '黄嵩', '口腔', '种植'], desc: '黄嵩医生（口腔种植/正畸）' },
  // —— 毛发移植科1位 ——
